        ...
        <div class="row">
            <div class="img-holder d-flex flex-column">
                ...
                <div class="info-holder" style="z-index:4;">
                    <br />
                    <a class=" btn btn-outline-light text-white" style="z-index: 10000;position: relative;" href="/">← Home</a>
                ...
                <div class="form-content" style="max-height: unset;">
                    ...
                    <img src="../image/logo.png" alt="" class="logo-light" height="81">
                        ...
                        <div class="card-header d-flex flex-wrap">
                            ...
                            <a href="/" style="z-index: 3;" class="btn p-2 btn-outline-primary mr-auto d-inline-flex align-items-center"><i class="fas fa-home fa-2x" title="home"></i></a>
                            ...
                            <form method="post" id="regForm" class="form form-horizontal" novalidate autocomplete="off" action="">
                                <div class="form-body">
                                    ...
                                    <div class="row d-flex flex-wrap">
                                        ...
                                        <p>or click<a href="/account/login"> here to login</a> if you have an account</p>
                                    </div>
                                </div>
                            </form>
                        </div>
